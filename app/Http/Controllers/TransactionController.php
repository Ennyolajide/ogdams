...
class TransactionController extends MessageController
{
     ...
     * Record Transaction
     */
    protected function recordTransaction($transactionRecord, $reference, $status = false, $chargeable = true, $method = false)
    {
        ...
        return Transaction::create([
            ...
            'reference' => $reference, 'method' => $method ? $method : 'Wallet', 'status' => $status ? 2 : 1
        ]);
    }
}
