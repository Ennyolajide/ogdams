        ...
        <script>
            $(document).ready(function() {
                ...
                $('#bonquet').change(function() {
                    ...
                    let bonquet = JSON.parse($(this).val());
                    $.each(bonquet, function( index, value ) {
                        $('#package').append('<option class="package-options" value='+value.id+'>'+value.name+' = '+value.selling_price);
                    });
                })
